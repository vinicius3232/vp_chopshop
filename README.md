...
Sistema avançado e server-authoritative de **desmanche clandestino de veículos** (chop shop) para FiveM.
Suporta stacks com **ox_lib / ox_target / ox_inventory / oxmysql** — frameworks **QBox (first-class / nativo)**, **QBCore** e **ESX Legacy** via Bridge layer unificada.

> 🌐 Documentação em Português: [README_pt.md](README_pt.md)
